...
目前正式版本為 v0.3.4：預設開啟 MONEY，底部固定為 MONEY／WORK／PROJECTS／REVIEW／DATA 五頁。v0.2 的瀏覽器資料與匯出 JSON 會自動升級為資料版本 2，儲存鍵仍為 `lifeCalibrationData`。
...
- 發布狀態：v0.3.4 已於 2026-08-03 推送並部署至既有 GitHub Pages。
